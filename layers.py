...
def disp_to_depth(disp, min_depth, max_depth):
    ...
    :return:
    """
    ## get inverse depth bounding
    min_disp = 1.0 / max_depth
    max_disp = 1.0 / min_depth

    ## get scaled inverse depth and scaled depth
    scaled_disp = min_disp + (max_disp - min_disp) * disp  # scaled inverse depth
    scaled_depth = 1.0 / scaled_disp

    return scaled_disp, scaled_depth


def transformation_from_parameters(axis_angle, translation, invert=False):
    """
    Convert the network's (axis_angle, translation) output into a 4x4 matrix
    :param axis_angle:
    :param translation:
    :param invert:
    :return:
...
class BackprojectDepth(nn.Module):
    ...
    def __init__(self, batch_size, height, width):
        ...
        ## transform to homogeneous coordinates(by adding 1s)
    ...
    def forward(self, depth, inv_K):
        ...
        pts3d = depth.view(self.batch_size, 1, -1) * cam_points

        ## to homogeneous coordinates
        pts3d_homo = torch.cat([pts3d, self.ones], 1)
...
class Project3D(nn.Module):
    ...
    def forward(self, points, K, T):
        ...
        :return:
        """
        ## camera matrix: including intrinsic and extrinsic parameters
