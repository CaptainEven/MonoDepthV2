...
def download_model_if_doesnt_exist(model_name, weights_dir='weights'):
    """
    ...
    sub_dirs = [x for x in os.listdir(weights_dir) if os.path.isdir(weights_dir + '/' + x)]
    if len(sub_dirs) > 0:
        model_path = os.path.join(weights_dir, model_name)
    else:
        model_path = weights_dir

    def check_file_matches_md5(checksum, f_path):
